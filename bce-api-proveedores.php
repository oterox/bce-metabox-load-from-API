<?php
/*
Plugin Name:  DEMO API proveedores
Description:  Show a list of providers
Version:      0.1.0
Author:       Javier Otero
Author URI:   https://k3.oterox.science/
*/
			...
			<p>
				...
				<select name="ox_proveedor" id="ox_proveedor">
					...
					foreach ($data->objects as $product) { ?>
						<option value="<?php echo $product->id; ?>" <?php selected($current_value, $product->id); ?>>
							<?php echo $product->email; ?></option>
						<?php
					}
					?>
				</select>
